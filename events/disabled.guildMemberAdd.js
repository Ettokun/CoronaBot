module.exports = class {
  ...
  async run(bot, member) {
    let channels = {
      rules: "688177294854193200",
      roles: "688177294854193200",
      intros: "688042000204693518",
      spam: "688188363412602925",
      general: "688041208806899786"
    };
    ...
    let welcome = new MessageEmbed()
      ...
      .addField(
        ...
        `This server is a great place to get to know some new college friends! Hop on over to <#${
        channels.general
